...
(function (window) {
    ...
    var Webcam = {
        ...
        detectFlash: function () {
            ...
            var SHOCKWAVE_FLASH = 'Shockwave Flash', SHOCKWAVE_FLASH_AX = 'ShockwaveFlash.ShockwaveFlash', FLASH_MIME_TYPE = 'application/x-shockwave-flash', win = window, nav = navigator, hasFlash = false;
        ...
        savePreview: function (user_callback, user_canvas) {
            ...
            user_callback(user_canvas
                ? null
                : canvas.toDataURL('image/' + params.image_format, params.jpeg_quality / 100), canvas, context);
            // remove preview
